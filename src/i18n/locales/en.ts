    ...
    navigator: {
        ...
        flows: {
            ...
            github: {
                ...
                tags: ['#SmallTeam', '#2-5 Developers', '#MostPopular', '#PullRequest', '#CodeReview', '#Simplicity'],
                branches: [
            ...
            gitlab: {
                ...
                tags: ['#MidSize', '#5-20 Developers', '#CICD', '#Stability'],
                branches: [
            ...
            gitflow: {
                ...
                tags: ['#LargeScale', '#StableRelease', '#ComplexDeployment', '#MultiVersionSupport'],
                branches: [
        ...
        steps: {
            ...
            pullMain: 'Pull the latest changes from the Main branch',
            pullDevelop: 'Pull the latest changes from the Develop branch',
            develop: 'Code Development & Changes (Develop)',
            stageAll: 'Stage All Changes',
            generateMessage: 'Generate Commit Message (AI Recommended)',
            commit: 'Commit Changes',
            push: 'Push to Remote Repository',
            pushToQAServer: 'Push (Trigger QA server deployment)',
            pushToProductionServer: 'Push (Trigger production server deployment)',
            createBranchAI: 'Create/Switch New Branch (AI Recommended)',
            createBranchManual: 'Create/Switch New Branch (Manual Input)',
            checkoutBranch: 'Switch Branch (Checkout)',
            checkoutToMain: 'Checkout to the Main branch',
            checkoutToPreProduction: 'Checkout to the pre-production branch',
            checkoutToProduction: ' Checkout to the production branch',
            checkoutToDevelop: 'Checkout to the Develop branch',
            mergeMain: 'Merge the Main branch',
            mergeDevelop: 'Merge the Develop branch',
            mergePreProduction: 'Merge the pre-production branch',
            mergeRelease: 'Merge the release/[version] branch',
            mergeHotfix: 'Merge the hotfix/[version] branch',
            deleteLocalBranch: 'Delete Local Branch',
            deleteReleaseBranch: 'Delete the release/[version] branch',
            deleteHotfixBranch: 'Delete the hotfix/[version] branch',
            createTagAndPush: 'Tag the Main branch',
            prReviewMain: 'After MR/PR review, Merge into the Main branch',
            prReviewDevelop: 'After MR/PR review, Merge into the Develop branch',
            qaTest: 'Conduct QA Testing',
            releaseBugfix: 'Release Bug Fix & Review',
            hotfixBugfix: 'Critical Hotfix Implementation',
        },
        
        accordions: {
            initialSetup: '⚙️ Initial Environment & Branch Setup (One-time)',
            featureDevelopment: '💻 Feature Development & Main Branch Integration',
            preProductionDeploy: '👀 Pre-production Deployment (Testing)',
            productionDeploy: '🌟 Production Deployment (Live)',
            releaseDeploy: '🚀 Release Preparation & Deployment (Testing)',
            hotfixDeploy: '🔥 Emergency Hotfix Deployment',
        },
