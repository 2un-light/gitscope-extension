...
export interface IGeminiService {
     ...
     */
    generateBranchNames(diff: string, count: number, t: ReturnType<II18nProvider['t']>): Promise<string[]>;
     ...
     */
    generateCommitMessage(diff: string, currentBranch: string, t: ReturnType<II18nProvider['t']>) : Promise<string>;
